	...
	if(array_key_exists('city', $_GET)) {
		...
		if(!$file_headers || $file_headers[0] == 'HTTP/1.1 404 Not Found') {
			...
			if (sizeof($pageArray) > 1) {
				...
				if (sizeof($nextpageArray) > 1) {
			
					$weather = $nextpageArray[0];
		...
		<div class="container">
			...
			<form>
				<div class="form-group">
					...
					<input type="text" class="form-control" id="city" name="city" placeholder="Eg. London, Mumbai" value="<?php
						if(array_key_exists('city', $_GET)) {
							echo $_GET['city'];
						}
					?>">
